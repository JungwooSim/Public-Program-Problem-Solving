package section1.nine_GreedyAlgorithm.one;
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i=0; i < n; i++) {
            bodys.add(
                    new Body(in.nextInt(), in.nextInt())
            );
        }

        System.out.println(main.solition(bodys));
    }

    private Integer solition(ArrayList<Body> bodys) {
        int result = 0;
